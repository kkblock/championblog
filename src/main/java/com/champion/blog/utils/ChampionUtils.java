...
public class ChampionUtils {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ChampionUtils.class);
     ...
     * 获取文件所在目录
     */
    private static String location = ChampionUtils.class.getClassLoader().getResource("").getPath();
...
//            默认是classPath路径
        ...
        } catch (ApiErrorInfoException | IOException e) {
    ...
    public static String getUploadFilePath() {
        String path = ChampionUtils.class.getProtectionDomain().getCodeSource().getLocation().getPath();
